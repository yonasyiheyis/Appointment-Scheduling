...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("provider/sessions/**").hasRole("Counselor")
		.antMatchers("POST/provider/sessions/**").hasAnyRole("Admin","Counselor")
		.antMatchers("/PUT/provider/session/**").hasAnyRole("Admin","Counselor")
		.antMatchers("/DELETE/provider/session/**").hasAnyRole("Admin","Counselor")
		.antMatchers("GET/client/appointments/**").permitAll()
		.antMatchers("POST/client/appointments/**").permitAll()
		.antMatchers("DELETE/client/appointment/**").permitAll()
		.antMatchers("POST/admin/appointments/**").permitAll()
		.antMatchers("/GET/person/**").hasRole("Admin")
		.antMatchers("/POST/person/**").hasRole("Admin")
		.antMatchers("DELETE/person/**").hasRole("Admin")
		.antMatchers("PUT/person/**").hasRole("Admin")
